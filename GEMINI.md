...
**Completion Trigger**: "Once a feature, bug fix, or logical unit of work is complete, you must generate a git commit message following Conventional Commits specifications (e.g., feat: add user auth, fix: resolve race condition, refactor: optimize database query).  Commit and push to GitHub."
